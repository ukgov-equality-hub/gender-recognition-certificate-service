...
# These 2 ensure invalid date is created before transition date
STATUTORY_DECLARATION_DATE_MONTH_MINUS_ONE = '2'
STATUTORY_DECLARATION_YEAR_MINUS_TWO = TRANSITION_DATE_YEAR
