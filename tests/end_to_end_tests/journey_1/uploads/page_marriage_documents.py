...
async def run_checks_on_page(page: Page, asserts: AssertHelpers, helpers: PageHelpers):
    ...
    # "Marriage documents" section should be marked as "IN PROGRESS"
    ...
    # Status of "Marriage documents" section should be "IN PROGRESS"
    ...
    await asserts.task_list_section(section='Marriage and civil partnership documents', expected_status='IN PROGRESS')
