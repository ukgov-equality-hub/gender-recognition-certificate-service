...
from grc.submit_and_pay.forms import MethodCheckForm, HelpTypeForm, CheckYourAnsewers, PaymentDetailsForm, PaymentConfirmationForm
...
def index():
    ...
    return render_template('submit-and-pay/method.html', form=form)
...
def helpType():
    ...
    return render_template('submit-and-pay/help-type.html', form=form)
...
def checkYourAnswers():
    ...
    return render_template('submit-and-pay/check-your-answers.html', form=form)
