...
from grc.birth_registration.forms import NameForm, SexForm, DobForm, UkCheckForm, CountryForm, PlaceOfBirthForm, FatherNameCheckForm, AdoptedForm, ForcesForm, CheckYourAnsewers
...
def index():
    ...
    if request.method == 'GET':
        form.first_name.data = session["application"]["birthRegistration"]["first_name"] if "first_name" in session["application"]["birthRegistration"] else None
        form.last_name.data = session["application"]["birthRegistration"]["last_name"] if "last_name" in session["application"]["birthRegistration"] else None
...
def dob():
    ...
    if request.method == 'GET'  and "dob" in session["application"]["birthRegistration"]:
        form.day.data = session["application"]["birthRegistration"]["dob"]["day"] if "day" in session["application"]["birthRegistration"]["dob"] else None
        form.month.data = session["application"]["birthRegistration"]["dob"]["month"] if "month" in session["application"]["birthRegistration"]["dob"] else None
        form.year.data = session["application"]["birthRegistration"]["dob"]["year"] if "year" in session["application"]["birthRegistration"]["dob"] else None
...
def country():
    ...
    if request.method == 'GET':
        form.country.data = session["application"]["birthRegistration"]["country"] if "country" in session["application"]["birthRegistration"] else None
...
def placeOfBirth():
    ...
    if request.method == 'GET':
        form.place_of_birth.data = session["application"]["birthRegistration"]["place_of_birth"] if "place_of_birth" in session["application"]["birthRegistration"] else None
...
def mothersName():
    ...
    if request.method == 'GET':
        form.first_name.data = session["application"]["birthRegistration"]["mothers_first_name"] if "mothers_first_name" in session["application"]["birthRegistration"] else None
        form.last_name.data = session["application"]["birthRegistration"]["mothers_last_name"] if "mothers_last_name" in session["application"]["birthRegistration"] else None
...
def fathersName():
    ...
    if request.method == 'GET':
        form.first_name.data = session["application"]["birthRegistration"]["fathers_first_name"] if "fathers_first_name" in session["application"]["birthRegistration"] else None
        form.last_name.data = session["application"]["birthRegistration"]["fathers_last_name"] if "fathers_last_name" in session["application"]["birthRegistration"] else None
...
def checkYourAnswers():
    ...
    if "birthRegistration" not in session["application"] or (session["application"]["birthRegistration"]["progress"] != ListStatus.IN_REVIEW.name and session["application"]["birthRegistration"]["progress"] != ListStatus.COMPLETED.name):
