...
class NameForm(FlaskForm):
    ...
    last_name = StringField(
        "last_name", validators=[DataRequired(message="Last name is required")]
    )
...
class UkCheckForm(FlaskForm):
    check = RadioField(
        ...
        choices=[("Yes"), ("No")],
        validators=[
            DataRequired(message="Select if your birth was registered in the UK")
        ],
    )
    submit = SubmitField("Save and continue")
...
class CountryForm(FlaskForm):
    country = StringField(
        "country", validators=[DataRequired(message="Country is required")]
    )
    submit = SubmitField("Save and continue")
...
class FatherNameCheckForm(FlaskForm):
    check = RadioField(
        ...
        validators=[
            DataRequired(
                message="Select if your father’s name is listed on the certificate"
            )
        ],
    )
    submit = SubmitField("Save and continue")
    ...
    adopted_uk = RadioField(
        ...
        validators=[
            StrictRequiredIf(
                "check",
                "Yes",
                message="Select if your were you adopted in the United Kingdom",
            )
        ],
    )
    submit = SubmitField("Save and continue")
...
class ForcesForm(FlaskForm):
    check = RadioField(
        ...
        validators=[
            DataRequired(
                message="Select if your was birth registered by a Forces registering service, or with a British Consul or High Commission, or under Merchant Shipping or Civil Aviation provisions"
            )
        ],
    )
    submit = SubmitField("Save and continue")
